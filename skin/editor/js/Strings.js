...
var Strings = function ( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/about': 'About-Us',
			//滤镜
			'menubar/filter': 'Filter',

			//天空
			'menubar/sky': 'Sky',
			'menubar/sky/sky1': 'Dusk-1',
			'menubar/sky/sky2': 'Dusk-2',
			'menubar/sky/sky4': 'Sunny -1',
			'menubar/sky/sky5': 'Sunny-2',
			'menubar/sky/sky6': 'Sunny-3',
			'menubar/sky/sky10': 'Night',

			//军事模型
			'menubar/military': 'Military-Model',
			'menubar/military/model1': 'Aircraft',
			'menubar/military/model2': 'Fighter',

			//工业模型

			'menubar/industry': 'Industrial-Model',
			'menubar/industry/model1': 'Mixing-Mill',
			'menubar/industry/model2': 'Chain-Machine',
			'menubar/industry/model3': 'Elevator',
			'menubar/industry/model4': 'Clamping-Machine',
			'menubar/industry/model5': 'Coder',
			'menubar/industry/model6': 'Stacker',
			'menubar/industry/model7': 'Hoist',
			'menubar/industry/model8': 'AGV',
			'menubar/industry/model9': 'RGV',
			'menubar/industry/model10': 'Wear-more cars',
			'menubar/industry/model11': 'Alphabetic-Shuttle',
			'menubar/industry/model12': 'Stacking-Robot',
			'menubar/industry/model13': 'Wrapping-machine',
		...
		zh: {
			...
			'menubar/industry': '工业模型',
			'menubar/industry/model1': '滚筒机',
			'menubar/industry/model2': '链条机',
			'menubar/industry/model3': '顶升移载',
			'menubar/industry/model4': '夹抱机',
			'menubar/industry/model5': '码盘机',
			'menubar/industry/model6': '堆垛机',
			'menubar/industry/model7': '提升机',
			'menubar/industry/model8': 'AGV',
			'menubar/industry/model9': 'RGV',
			'menubar/industry/model10': '多穿小车',
			'menubar/industry/model11': '字母穿梭车',
			'menubar/industry/model12': '堆垛机器人',
			'menubar/industry/model13': '裹膜机',
			'menubar/industry/model14': '叉车',
			'menubar/industry/model15': '牵引车',

			'menubar/military': '军事模型',
			'menubar/military/model1': '客机',
			'menubar/military/model2': '战斗机',
			...
			'menubar/sky': '天空',
			'menubar/sky/sky1': '黄昏-1',
			'menubar/sky/sky2': '黄昏-2',
			'menubar/sky/sky3': '街道',
			'menubar/sky/sky4': '晴天-1',
			'menubar/sky/sky5': '晴天-2',
			'menubar/sky/sky6': '晴天-3',
			'menubar/sky/sky7': '室内-1',
			'menubar/sky/sky8': '室内-2',
			'menubar/sky/sky9': '室内-3',
			'menubar/sky/sky10': '夜晚',
			'menubar/sky/sky11': '阴天',
