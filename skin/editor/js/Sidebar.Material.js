			...
			if ( material.alphaMap !== undefined ) {
				...
				if ( objectHasUvs ) {
					...
					if ( material.alphaMap !== alphaMap ) {
						...
						// console.log(mapEnabled+"透明贴图")
						if( mapEnabled === true ){
							alphaMap.wrapS=alphaMap.wrapT=1000;
						}
			...
			if ( material.displacementMap !== undefined ) {
				...
				if ( objectHasUvs ) {
					...
					if ( material.displacementMap !== displacementMap ) {
						...
						// console.log(displacementMapEnabled+"置换贴图")
