...
THREE.TransformControlsGizmo = function () {
	...
	// 变换辅助对象的特殊几何图形。如果用位置矢量缩放，则从[0,0,0]到位置
	...
	//gizmo定义-setupgizmo（）函数的自定义层次结构定义
	...
	//updateMatrixWorld将更新各个句柄的转换和外观
